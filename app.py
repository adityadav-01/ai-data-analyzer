...
# --------------------------------------------------
# HERO SECTION (Only When No File Uploaded)
# --------------------------------------------------
if uploaded_file is None:

    st.markdown("""
    <div class="hero-container">
        <div class="hero-title">🚀 AI Data Analyzer</div>
        <div class="hero-subtitle">
            Transform Raw Data into Smart Insights & Future Predictions
        </div>
        <div class="start-box">
            👉 Chaliye shuru karte hain! <br>
            Upload your dataset from the sidebar to begin analysis.
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if section == "Forecasting":
    ...
    if len(date_cols) > 0 and len(numeric_cols) > 0:
        ...
        if st.button("Generate Forecast"):
            ...
            future_full = model.make_future_dataframe(periods=730, freq=freq)
